...
public:
	...
	void ProtectedViewWindowOpen(LPDISPATCH PvWindow)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x1f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PvWindow);
	}
	void ProtectedViewWindowBeforeEdit(LPDISPATCH PvWindow, BOOL * Cancel)
	{
		static BYTE parms[] = VTS_DISPATCH VTS_PBOOL ;
		InvokeHelper(0x20, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PvWindow, Cancel);
	}
	void ProtectedViewWindowBeforeClose(LPDISPATCH PvWindow, long CloseReason, BOOL * Cancel)
	{
		static BYTE parms[] = VTS_DISPATCH VTS_I4 VTS_PBOOL ;
		InvokeHelper(0x21, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PvWindow, CloseReason, Cancel);
	}
	void ProtectedViewWindowSize(LPDISPATCH PvWindow)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x22, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PvWindow);
	}
	void ProtectedViewWindowActivate(LPDISPATCH PvWindow)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x23, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PvWindow);
	}
	void ProtectedViewWindowDeactivate(LPDISPATCH PvWindow)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x24, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PvWindow);
	}
